...
restService.post('/hook', function (req, res) {
    ...
    console.log('Got a new request: ', JSON.stringify(req));
    console.log('Got a new response: ', JSON.stringify(res));
    

    try {
        if (!bodyReq || !bodyReq.parameters ||  !bodyReq.parameters.product || bodyReq.parameters.product === 0) {
