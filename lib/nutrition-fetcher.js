...
const SEARCH_ITEMS_DEFAULT_MAX_RESULT = 5;
...
NutritionFetcher.prototype.searchFoods = function(searchTerms, maxResults) {
	 console.log('Search URL ', SEARCH_ITEMS_ENDPOINT);
    return req({
        method: 'GET',
        ...
        transform: (body) => {
            ...
            console.log('inside food searchFoods:',foodItems);
            return foodItems;
        }
    })
};
    ...
    return req({
        ...
        transform: (body) => {
            ...
            if (body.report.food.nutrients) {
                ...
                console.log('inside food getNutritions body:',body);
            return nutrients;
        }
    })
};
